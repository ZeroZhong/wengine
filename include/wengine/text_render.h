...
namespace WEngine
{
  ...
  TextRender::TextRender(unsigned int width, unsigned int height)
  {
    ...
    this->TextShader = ResourceManager::LoadShader(FileSystem::getPath("text_2d.vs").c_str(),
                                                   FileSystem::getPath("text_2d.fs").c_str(),
                                                   nullptr, "text");
  ...
  void TextRender::Load(std::string font, unsigned int fontSize)
  {
